        ...
        >
          ...
          <Fade up>
            <Text color={"white.600"} fontSize={"xl"} px={4}>
              ...
              Computer Science, along with a certificate in Statistics and
              Machine Learning and Finance. Currently, I contribute to the
              website and mobile development for The Daily Princetonian and
              also am a TA for Princeton's Algorithm and Data Structure course.
